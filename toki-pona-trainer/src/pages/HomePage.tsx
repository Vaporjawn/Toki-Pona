    ...
    <Box sx={{ width: '100%', maxWidth: '100%' }}>
      ...
      <Box sx={{ mb: 8, px: { xs: 2, sm: 3, md: 4 } }}>
        ...
        <Typography variant="h6" textAlign="center" color="text.secondary" sx={{ mb: 6 }}>
          Discover why toki pona is the perfect language to learn quickly
        </Typography>
      ...
      <Paper
        sx={{
          ...
          mb: 8,
          mx: { xs: 2, sm: 3, md: 4 },
          background: 'linear-gradient(135deg, #FFA726 0%, #FFD95A 100%)',
          textAlign: 'center',
        }}
      >
        ...
        <Typography variant="body1" sx={{ color: 'white', opacity: 0.8, maxWidth: 500, mx: 'auto' }}>
          With just 120-137 core words, toki pona encourages simple, clear thinking.
          Every concept can be expressed through creative combinations of basic words.
        </Typography>
      </Paper>
      ...
      >
        ...
        <Typography variant="body1" color="text.secondary" sx={{ mb: 4 }}>
          Join thousands of learners discovering the joy of simple, meaningful communication
        </Typography>
        <Button
          component={Link}
          to="/lessons"
